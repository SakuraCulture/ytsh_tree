...
public class AbstractHttpClient {
    ...
    protected static Throwable buildException(String content)
        ...
        Throwable throwable = Json2Deserializer.buildException(content);
        return throwable;
    }
    ...
    protected <T> BizResultWrapper<T> buildResult(String content, Class<T> classType)
            throws IOException, ParseException {
        BizResultWrapper<T> result = JSON.parseObject(content, new TypeReference<BizResultWrapper<T>>(classType) {
        });
        return result;
    }
