...
public class AppProductSpuController {
    ...
    @Operation(summary = "鑾峰緱鍟嗗搧 SPU 鍒楄〃")
    ...
    @GetMapping("/page")
    @Operation(summary = "鑾峰緱鍟嗗搧 SPU 鍒嗛〉")
    ...
    @Operation(summary = "鑾峰緱鍟嗗搧 SPU 鏄庣粏")
    ...
    public CommonResult<AppProductSpuDetailRespVO> getSpuDetail(@RequestParam("id") Long id) {
        ...
        // 澧炲姞娴忚閲?        productSpuService.updateBrowseCount(id, 1);
        // 淇濆瓨娴忚璁板綍
