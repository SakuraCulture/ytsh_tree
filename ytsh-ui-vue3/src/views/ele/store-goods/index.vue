<template>
  <div class="app-container">
    <el-tabs v-model="activeTab" class="store-goods-tabs">
      <el-tab-pane label="商品查询与同步" name="sync">
    ...
    <div class="log-card">
      ...
      <el-tab-pane label="待治理池" name="governance">
        <GovernancePoolPanel />
      </el-tab-pane>
      <el-tab-pane label="全量同步任务" name="fullSync">
        <FullSyncTaskPanel />
      </el-tab-pane>
    </el-tabs>
...
import GovernancePoolPanel from './components/GovernancePoolPanel.vue'
import FullSyncTaskPanel from './components/FullSyncTaskPanel.vue'
...
defineOptions({ name: 'EleStoreGoodsSync' })
