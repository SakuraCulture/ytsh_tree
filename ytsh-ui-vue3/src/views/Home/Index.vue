<template>
  ...
  <div class="mt-8px flex justify-center items-center" style="height: 150px;">
    <img src="/zhuzhuxia.png" alt="" style="height: 100px; transform: scale(2); object-fit: contain; margin-top: 30px;" />
  </div>

  <el-row class="mt-8px" :gutter="8" justify="space-between">
    <el-col :xl="16" :lg="16" :md="24" :sm="24" :xs="24" class="mb-8px" v-if="false">
      <el-card shadow="never">
        <template #header>
    ...
    <el-col :xl="8" :lg="8" :md="24" :sm="24" :xs="24" class="mb-8px" v-if="false">
      <el-card shadow="never">
        <template #header>
          <div class="h-3 flex justify-between">
