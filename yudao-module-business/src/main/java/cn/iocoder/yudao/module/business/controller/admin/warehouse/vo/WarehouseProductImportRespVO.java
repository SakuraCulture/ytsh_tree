...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "仓库商品导入结果 VO")
public class WarehouseProductImportRespVO {
    ...
    @Schema(description = "失败的仓库商品ID和原因", requiredMode = Schema.RequiredMode.REQUIRED)
    private Map<String, String> failureWarehouseProductIds;
}
