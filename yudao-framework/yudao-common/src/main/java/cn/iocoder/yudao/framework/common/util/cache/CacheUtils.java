...
public class CacheUtils {
    ...
    private static final ExecutorService CACHE_RELOAD_EXECUTOR = new ThreadPoolExecutor(
            2, 8, 60L, TimeUnit.SECONDS,
            new LinkedBlockingQueue<>(100),
            new ThreadFactoryBuilder().setNameFormat("cache-reload-%d").build(),
    ...
    public static <K, V> LoadingCache<K, V> buildAsyncReloadingCache(Duration duration, CacheLoader<K, V> loader) {
        return CacheBuilder.newBuilder()
                ...
                .build(CacheLoader.asyncReloading(loader, CACHE_RELOAD_EXECUTOR));
    }
